...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
       ...
       # try:
        ...
        try:
            driver.find_element(By.CSS_SELECTOR, '.CloseButton').click() #clicking to the X.
            print(' x out worked')
        except NoSuchElementException:
            print(' x out failed')
            pass
        ...
        job_buttons = driver.find_element(By.CLASS_NAME,"JobsList_jobListItem__wjTHv JobsList_dividerWithSelected__nlvH7")  #jl for Job Listing. These are the buttons we're going to click.
        for job_button in job_buttons:  
            ...
            while not collected_successfully:
                try:
                    ...
                    job_title = driver.find_element(By.XPATH,driver, './/div[contains(@class, "title")]').text
